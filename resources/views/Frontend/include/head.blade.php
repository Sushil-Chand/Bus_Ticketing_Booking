<head>
    ...
    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="{{asset('frontend/assets/logo/buslogo.png')}}"/>
    ...
    <link href="{{asset('frontend/assets/bootstrap-5.3.3-dist/css/bootstrap.css')}}" rel="stylesheet">
